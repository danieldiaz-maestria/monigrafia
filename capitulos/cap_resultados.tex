...
\begin{table}[ht]
\centering
\caption{Estadísticas de Error de Distancia - Dispositivo en Cabeza}
\label{tab:error_cabeza}
\begin{tabular}{lcccc}
\toprule
\textbf{Escenario} & \textbf{Condición} & \textbf{MAE (cm)} & \textbf{Desv. Est. (cm)} & \textbf{Error Máx. (cm)} \\
\midrule
Exterior & LOS & 4.87 & 3.72 & 15 \\
Exterior & NLOS & 32.05 & 10.16 & 53 \\
Interior & LOS & 10.43 & 9.21 & 48 \\
Interior & NLOS & 18.66 & 11.20 & 64 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Estadísticas de Error de Distancia - Dispositivo en Cadera}
\label{tab:error_cadera}
\begin{tabular}{lcccc}
\toprule
\textbf{Escenario} & \textbf{Condición} & \textbf{MAE (cm)} & \textbf{Desv. Est. (cm)} & \textbf{Error Máx. (cm)} \\
\midrule
Exterior & LOS & 8.31 & 5.34 & 25 \\
Exterior & NLOS & 94.78 & 52.46 & 189 \\
Interior & LOS & 7.19 & 7.86 & 37 \\
Interior & NLOS & 97.76 & 71.00 & 290 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Estadísticas de Error de Distancia - Dispositivo en Rodilla}
\label{tab:error_rodilla}
\begin{tabular}{lcccc}
\toprule
\textbf{Escenario} & \textbf{Condición} & \textbf{MAE (cm)} & \textbf{Desv. Est. (cm)} & \textbf{Error Máx. (cm)} \\
\midrule
Exterior & LOS & 14.99 & 10.59 & 46 \\
Exterior & NLOS & 55.54 & 36.11 & 131 \\
Interior & LOS & 12.04 & 8.43 & 35 \\
Interior & NLOS & 49.55 & 37.68 & 181 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Estadísticas de Error de Distancia - Dispositivo en Tobillo}
\label{tab:error_tobillo}
\begin{tabular}{lcccc}
\toprule
\textbf{Escenario} & \textbf{Condición} & \textbf{MAE (cm)} & \textbf{Desv. Est. (cm)} & \textbf{Error Máx. (cm)} \\
\midrule
Exterior & LOS & 29.87 & 20.86 & 105 \\
Exterior & NLOS & 38.86 & 19.44 & 85 \\
Interior & LOS & 41.50 & 28.67 & 147 \\
Interior & NLOS & 29.96 & 15.89 & 81 \\
\bottomrule
\end{tabular}
\end{table}

El tobillo presenta MAE superiores a 29 cm en todas las configuraciones. Contraintuitivamente, en interior NLOS (29.96 cm) supera el desempeño de LOS (41.50 cm) con factor de mejora de 1.4×. Este fenómeno sugiere que las reflexiones del piso y paredes en el corredor compensan parcialmente la atenuación por obstrucción corporal.
...
\begin{table}[ht]
\centering
\caption{Estadísticas de Error de Distancia - Dispositivo en Mano y Muñeca}
...
\midrule
\multirow{4}{*}{Mano} & Exterior & LOS & 8.98 & 6.39 & 32 \\
& Exterior & NLOS & 41.60 & 12.14 & 73 \\
& Interior & LOS & 9.47 & 7.74 & 35 \\
& Interior & NLOS & 26.01 & 23.92 & 156 \\
\midrule
\multirow{4}{*}{Muñeca} & Exterior & LOS & 7.78 & 5.99 & 32 \\
& Exterior & NLOS & 24.07 & 7.71 & 45 \\
& Interior & LOS & 6.42 & 4.09 & 19 \\
& Interior & NLOS & 22.00 & 13.21 & 81 \\
\bottomrule
\end{tabular}
\end{table}
...
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
 & \textbf{LOS (cm)} & \textbf{NLOS (cm)} & \textbf{LOS (cm)} & \textbf{NLOS (cm)} \\
\midrule
...
\item \textbf{Tobillo:} Muestra el comportamiento más atípico del estudio. Presenta MAE elevados incluso en LOS (29.81 cm exterior, 41.48 cm interior). Contraintuitivamente, el escenario NLOS exhibe mejor desempeño en interior (29.96 cm) que en LOS, con factor de mejora de 1.4×. En exterior NLOS alcanza 38.45 cm.
