\chapter{RESULTADOS EXPERIMENTALES - FASE 1: VALIDACIÓN DE ESTIMACIÓN DE DISTANCIA}
\label{ch:resultados}
...
Los resultados se presentan mediante tablas, gráficas y análisis estadísticos descriptivos, evitando en esta sección la interpretación profunda que se realizará en el capítulo de análisis y discusión.
